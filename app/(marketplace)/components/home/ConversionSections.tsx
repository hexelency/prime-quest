...
export function HomeFooter({ buyerLink }: { buyerLink: (message: string) => string }) {
  return <footer className="footer" id="contact"><div className="shell footer-grid"><a className="brand" href="#top"><span className="brand-mark">PQ</span><span><strong>PRIMEQUEST</strong><small>OIL · VESSELS · PROPERTIES</small></span></a><p>Connecting genuine sellers<br />with genuine buyers.</p><div><a href="/about">About PrimeQuest ↗</a><a href="/mission">Our mission</a><a href="/faq">FAQs</a><a href="/privacy">Privacy policy</a><a href="/terms">Terms of listing</a><a href="/contact">Contact us</a><a href="https://www.linkedin.com/in/ugochukwu-lawrence-festus-94470a439" target="_blank" rel="noreferrer">LinkedIn ↗</a><a href={buyerLink("Hello PrimeQuest, I have a general inquiry.")} target="_blank" rel="noreferrer">WhatsApp PrimeQuest ↗</a><a href="mailto:info@primequest.com.ng">info@primequest.com.ng</a><a href="tel:+2348036598189">+234 803 659 8189</a></div></div><div className="shell footer-bottom"><span>© 2026 PrimeQuest Oil and Properties Consultants</span><span>Asaba · Delta State · Nigeria</span></div></footer>;
}
