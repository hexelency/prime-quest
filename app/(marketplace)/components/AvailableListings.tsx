...
export default function AvailableListings({ listings }: { listings: readonly AvailableListing[] }) {
  ...
  return <div className="available-listings" id="available-listings">
    ...
    <div className="available-meta"><span>{visibleListings.length} of {listings.length} available records</span><span>Admin-published inventory feed · demo data</span></div>
