  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <div><p className={styles.eyebrow}>Private intake</p><h1>Seller mandates</h1><p className={styles.description}>Review submitted seller information, consent, attachments and matching actions from the live database.</p></div>
        <div><button className={styles.primary} type="button" disabled={matching} onClick={() => runMatching("all")}>{matching ? "Scanning..." : "Match all buyers"}</button><a className={styles.primary} href="/mandate">+ New mandate</a></div>
      </header>
